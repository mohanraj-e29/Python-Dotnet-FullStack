<%@ Page Title="" Language="C#" MasterPageFile="~/view/admin/Site1.Master" AutoEventWireup="true" CodeBehind="customer.aspx.cs" Inherits="aspproject.view.admin.customer" %>
            ...
            <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <img src="../../asserts/img/cstr.jpg" width="200px" height="250px" alt="no image here.." /></div>
                    <div class="col"></div>
                </div>
                <div class="row">
                    <div class="col">
